...
<ul class="shortcuts">
    ...
    <li class="help">
        <a href="<?php echo Yii::app()->baseUrl; ?>/orders">
            <span class="shortcuts-icon iconsi-help"></span>
            <span class="shortcuts-label">Manage Orders</span>
        </a>
    </li>
    <li class="help">
        <a href="<?php echo Yii::app()->baseUrl; ?>/creditLog">
            <span class="shortcuts-icon iconsi-help"></span>
            <span class="shortcuts-label">Credit Log</span>
        </a>
    </li>
    <!--<li class="help">
        <a href="<?php echo Yii::app()->baseUrl; ?>/ordersDetails">
            <span class="shortcuts-icon iconsi-help"></span>
            <span class="shortcuts-label">Manage Order Details</span>
        </a>
    </li>-->
