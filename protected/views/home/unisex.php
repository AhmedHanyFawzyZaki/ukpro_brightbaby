...
<div class="wrapper">
                ...
                <label class="checkbox">0-3 MONTHS<input name="unisex_sizes[]" value="1" onchange="filtering(this);" type="checkbox"></label>
                <label class="checkbox">3-6 MONTHS<input name="unisex_sizes[]" value="2" onchange="filtering(this);" type="checkbox"></label>
                <label class="checkbox">6-9 MONTHS<input name="unisex_sizes[]" value="3" onchange="filtering(this);" type="checkbox"></label>
                <label class="checkbox">9-12 MONTHS<input name="unisex_sizes[]" value="4" onchange="filtering(this);" type="checkbox"></label>
                </div>
...
{
 var checkedValue=[];
 var inputElements = document.getElementsByName('unisex_sizes[]');
...
$.ajax({    
        url: "<?= Yii::app()->request->baseUrl ;?>/home/Filtering?checkedValue="+checkedValue+"&cat_id="+3,        
        type: 'GET',
