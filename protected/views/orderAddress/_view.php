<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('phone_day')); ?>:</b>
	<?php echo CHtml::encode($data->phone_day); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('phone_evening')); ?>:</b>
	<?php echo CHtml::encode($data->phone_evening); ?>
	<br />
