        ...
        $this->widget('bootstrap.widgets.TbNavbar', array(
            'items' => array(
                array(
                    ...
                    'items' => array(
                        array('label' => 'Main Site', 'url' => array('/home/index'), 'itemOptions' => array('class' => 'main-site-link')),
                        ...
                        array('label' => 'Content', 'url' => '#', 'items' => array(
                                ...
                                array('label' => 'FAQs', 'url' => array('/faq')),
                                //array('label'=>'Press', 'url'=>array('/press')),                 	
                                array('label' => 'Countries', 'url' => array('/countries')),
                            ), 'itemOptions' => array('class' => 'main-site-link2'), 'visible' => User::CheckAdmin()),
                        array('label' => 'Newsletters', 'url' => '#', 'items' => array(
                                //array('label' => 'Newsletters Subscribers', 'url' => array('/newsletters')),
                                array('label' => 'Send Email', 'url' => array('/newsletterMessage')),
                            ), 'itemOptions' => array('class' => 'main-site-link2'), 'visible' => User::CheckAdmin()),
                        //array('label'=>'Newsletters', 'url'=>array('/newsletters'),'itemOptions'=>array('class' => 'main-site-link2'), 'visible'=>User::CheckAdmin()),
                        array('label' => 'Products', 'url' => '#', 'items' => array(
                                array('label' => 'Products', 'url' => array('/products')),
                                array('label' => 'Products Ordering', 'url' => array('/products/order')),
                                array('label' => 'Products Category', 'url' => array('/productCategory')),
                                array('label' => 'Products Colors', 'url' => array('/colors')),
                                array('label' => 'Products Sizes', 'url' => array('/sizes')),
                            ), 'itemOptions' => array('class' => 'main-site-link2'), 'visible' => User::CheckAdmin()),
                        array('label' => 'Users', 'url' => array('/user'), 'itemOptions' => array('class' => 'main-site-link3'), 'visible' => User::CheckAdmin()),
                        ...
                        array('label' => 'Orders', 'url' => '#', 'items' => array(
                                ...
                                array('label' => 'Discount Codes', 'url' => array('/discount')),
                            ), 'itemOptions' => array('class' => 'main-site-orders'), 'visible' => User::CheckAdmin()),
                        //array('label'=>'Credit Log', 'url'=>array('/CreditLog'),'itemOptions'=>array('class' => 'main-site-money'), 'visible'=>User::CheckAdmin()),
